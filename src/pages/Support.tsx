...
const documentationLinks = [
  { title: "Getting Started Guide", url: "#", category: "Basics" },
  { title: "Tool Integration Setup", url: "#", category: "Integration" },
  { title: "Workflow Automation", url: "#", category: "Automation" },
  { title: "Security Best Practices", url: "#", category: "Security" },
  { title: "API Reference", url: "#", category: "API" },
  { title: "Troubleshooting Guide", url: "#", category: "Support" }
];
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {documentationLinks.map((link, index) => (
              <div 
                key={index}
                className="flex items-center justify-between p-3 border border-border rounded-lg hover:bg-muted/20 transition-colors cursor-pointer"
              >
                <div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            {[
              ...
              { service: "Workflow Engine", status: "operational", uptime: "99.8%" },
              { service: "Tool Integrations", status: "operational", uptime: "99.7%" },
